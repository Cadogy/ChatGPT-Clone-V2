...
function Message({ message }: Props) {
  ...
  return (
    <div className={`py-5 my-3 max-w-[96%] mx-auto rounded-lg text-lightMode-text dark:text-darkMode-text ${isChatGPT && "bg-lightMode-secondary dark:bg-darkMode-secondary"}`}>
