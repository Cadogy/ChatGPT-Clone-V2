...
function ChatInput({ chatId }: Props) {
  ...
  return (
    <div className="bg-zinc-700/30 text-gray-400 rounded-lg text-sm mb-2 mx-2">
      <form onSubmit={sendMessage} className="rounded-lg transition-all ease-in-out hover:bg-zinc-600/30 p-3 space-x-5 flex">
        <input 
